...
#ifndef QT_TO_UTF8
#define QT_TO_UTF8(qs) (qs.toUtf8().constData())
#endif

static QString SelectDirectory(QWidget *parent, const QString &title, const QString &dir)
{
    return QFileDialog::getExistingDirectory(parent, title, dir);
}

static QString OpenFile(QWidget *parent, const QString &title, const QString &dir,
            const QString &filter)
{
    return QFileDialog::getOpenFileName(parent, title, dir, filter);
}

static QString SaveFile(QWidget *parent, const QString &title, const QString &dir,
            const QString &filter)
{
    return QFileDialog::getSaveFileName(parent, title, dir, filter);
}

static QStringList OpenFiles(QWidget *parent, const QString &title, const QString &dir,
                 const QString &filter)
{
    return QFileDialog::getOpenFileNames(parent, title, dir, filter);
}
...
void OBSPropertiesView::RefreshProperties()
{
    ...
    /* 🔥 MODIFICADO: permitir compresión horizontal */
    QSizePolicy mainPolicy(QSizePolicy::Expanding, QSizePolicy::MinimumExpanding);
    ...
    /* 🔥 MODIFICADO: aplicar política expansiva al propio view */
      ...
      minSize(minSize_)
{
    ...
    /* 🔥 AÑADIDO: matar scroll vertical interno */
